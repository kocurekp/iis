            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                ...
                '.$state.'
                    ...
                    <form action="../obsah/task.php" method="post" accept-charset="utf-8">
                        <h4 class="card-title"><a>Task for ticket: #'.$row['ID_ticket'].'</a></h4>

                        <p class="card-text">desc: '.$row['description'].'</p>                        <p class="card-text">worker: '.$username.'</p>
                        <p class="card-text">estm_time: '.$row['estm_time'].'</p>
